...
<head>
    ...
    <title>更新メンバー管理 | BNI Slide System V2</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-calendar-alt"></i> 更新メンバー情報管理</h2>
            </div>

            <div class="info-box">
                <h4><i class="fas fa-info-circle"></i> 更新メンバー管理について</h4>
                <ul>
                    <li>p.98 & p.229: 更新メンバー紹介スライド（両ページに同じメンバーが表示されます）</li>
                    <li>更新メンバーを選択して登録してください</li>
                    <li>既存のメンバーから選択できます</li>
            ...
            <div class="actions-bar">
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                    ...
                    <button class="btn btn-success" onclick="openSlide(98)">
                        <i class="fas fa-play"></i> p.98 プレビュー
                    </button>
                    <button class="btn btn-success" onclick="openSlide(229)">
                        <i class="fas fa-play"></i> p.229 プレビュー
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        async function loadRenewalMembers() {
            try {
                ...
                if (data.success) {
                    renewalMembers = data.renewal_members;
                    renderRenewalMembers();
                    document.getElementById('memberCount').textContent = renewalMembers.length;
                }
            } catch (error) {
                console.error('更新メンバー読み込みエラー:', error);
                alert('データの読み込みに失敗しました');
            }
        }

        // 更新メンバー一覧表示
        function renderRenewalMembers() {
