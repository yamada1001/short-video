...
// 連絡先情報
define('PHONE', '097-597-3033'); // 電話番号
define('PHONE_LINK', 'tel:0975973033'); // tel:リンク用（ハイフンなし）
define('TEL', '0975973033'); // tel:リンク用（ハイフンなし）
define('TEL_DISPLAY', '097-597-3033'); // 表示用電話番号
define('EMAIL', 'kimshin94236@gmail.com'); // メールアドレス
