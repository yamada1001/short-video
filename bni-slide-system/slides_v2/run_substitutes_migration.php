<?php
/**
 * 本番サーバー用: substitutes テーブルのweek_dateをNULLABLEに変更
 * URL: https://yojitu.com/bni-slide-system/slides_v2/run_substitutes_migration.php
 */
...
echo "========================================\n";
echo "Substitutes Migration: Fix week_date to NULLABLE\n";
echo "========================================\n\n";
