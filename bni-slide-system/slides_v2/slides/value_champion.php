<?php
/**
 * BNI Slide System V2 - Value Champion Slide (p.92)
 * バリューチャンピオン
 */
...
$stmt = $db->prepare("
    ...
    WHERE c.category = 'value' AND c.week_date = (SELECT MAX(week_date) FROM champions WHERE category = 'value')
...
<head>
    ...
    <title>バリューチャンピオン | BNI Slide System V2</title>
...
<body>
    <div class="slide-container">
        <div class="title">
            <i class="fas fa-dollar-sign"></i> Value Champion
        </div>
        <div class="subtitle">バリューチャンピオン</div>
