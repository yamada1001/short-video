...
<body>
  ...
  <div class="container">
    <header>
      <h1><i class="fas fa-user-friends"></i> ビジターご紹介管理</h1>
      <nav>
        <a href="edit.php"><i class="fas fa-edit"></i> 編集画面</a>
        <a href="networking_learning.php"><i class="fas fa-chalkboard-teacher"></i> ネットワーキング学習コーナー</a>
        <a href="slide.php"><i class="fas fa-presentation"></i> スライド表示</a>
