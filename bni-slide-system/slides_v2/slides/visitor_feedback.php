<?php
/**
 * BNI Slide System V2 - Visitor Feedback Slide (p.213-224)
 * ビジター感想スライド（1人につき1ページ、23秒カウントダウン）
 */
...
<head>
    ...
    <title>ビジター感想 (p.<?= 213 + $currentIndex ?>) | BNI Slide System V2</title>
...
<body>
    <div class="slide-container">
        <h1 class="slide-title">
            <span class="visitor-name"><?= htmlspecialchars($currentVisitor['name']) ?></span> 様による<br>
            本日の一言感想
        </h1>

        <div class="feedback-area">
            <div class="feedback-label">感想をお聞かせください</div>
            <div class="feedback-placeholder">（23秒でお願いします）</div>
        </div>
