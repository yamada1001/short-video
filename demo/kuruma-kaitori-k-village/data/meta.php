...
$meta = [
    ...
    'kaitori' => [
        'title' => '車買取サービス | くるま買取ケイヴィレッジ',
        'description' => '大分市の車買取専門店。無料査定、出張査定対応、即日現金買取可能。国産車・輸入車問わず高価買取いたします。他社より高い買取価格を実現。',
        'keywords' => '車買取,高価買取,無料査定,出張査定,即日買取,大分,中判田',
        'og_image' => 'assets/images/kaitori/og-kaitori.jpg'
    ],

    'lease' => [
        'title' => '新車リースサービス | くるま買取ケイヴィレッジ',
        'description' => '頭金不要、月々定額で新車に乗れるリースサービス。車検・メンテナンス込みで安心。全メーカー対応。大分市の新車リースならケイヴィレッジ。',
        'keywords' => '新車リース,カーリース,頭金0円,月々定額,車検込み,大分,中判田',
        'og_image' => 'assets/images/lease/og-lease.jpg'
    ]
];
