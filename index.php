    ...
    <section class="hero">
        <div class="hero__background">
            <svg class="hero__svg" viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle class="hero__data-point hero__data-point--1" cx="750" cy="550" r="8" fill="#63584C" opacity="0.5"/>
                <circle class="hero__data-point hero__data-point--2" cx="820" cy="480" r="9" fill="#63584C" opacity="0.5"/>
                <circle class="hero__data-point hero__data-point--3" cx="890" cy="400" r="10" fill="#63584C" opacity="0.6"/>
                <circle class="hero__data-point hero__data-point--4" cx="960" cy="300" r="11" fill="#63584C" opacity="0.6"/>
                <circle class="hero__data-point hero__data-point--5" cx="1030" cy="200" r="12" fill="#63584C" opacity="0.7"/>

                <!-- 接続線（上昇データフロー） -->
                <polyline class="hero__line" points="750,550 820,480 890,400 960,300 1030,200" fill="none" stroke="#63584C" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" opacity="0.35"/>
