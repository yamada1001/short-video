...
<body>
  ...
  <div class="manual-container">
    ...
    <div id="member" class="manual-section">
      ...
      <h4>4. リファーラル情報の入力（複数可）</h4>
      <p>リファーラルを提供した場合、以下の情報を入力します。</p>
      <ul>
        <li><strong>案件名</strong>: リファーラルの内容（例: ホームページ制作依頼）</li>
        <li><strong>金額</strong>: 見込み金額（半角数字、例: 500000）</li>
        <li><strong>カテゴリ</strong>: 業種カテゴリ（例: IT、建設、飲食）</li>
        <li><strong>提供者</strong>: リファーラルを受け取るメンバー名</li>
      </ul>

      <div class="info-box">
        <h4><i class="fas fa-plus-circle"></i> 複数のリファーラルを追加する場合</h4>
        <ul>
          <li>「+ リファーラルを追加」ボタンをクリック</li>
          <li>新しい入力欄が表示されます</li>
          <li>最大10件まで追加可能</li>
        </ul>
      </div>
      ...
      <h4>5. その他の活動入力</h4>
      <ul>
        <li><strong>サンクスリップ提出数</strong>: 先週提出したサンクスリップの枚数（半角数字）</li>
        <li><strong>ワンツーワン実施数</strong>: 先週実施したワンツーワンの回数（半角数字）</li>
        <li><strong>コメント</strong>（任意）: 自由記述欄</li>
      </ul>
      ...
      <ol class="step-list">
        ...
        <li>ビジター/リファーラルの追加: 「+ ビジターを追加」または「+ リファーラルを追加」ボタンをクリック</li>
        <li>ビジター/リファーラルの削除: 各項目の「削除」ボタンをクリック</li>
        <li>「保存」ボタンをクリック</li>
