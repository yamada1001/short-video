...
楽しく体験しながらAIアシスタントの使い方を学べるWebアプリケーション

## 📌 プロジェクト概要

- **コンセプト**: AIへの話しかけ方を、実際に試しながら楽しく学習
- **学習形式**: スライド、体験、クイズ、チャレンジの4タイプ
...
**Phase 3: コア学習機能**
- ✅ コース・ステップページ（がんばり記録表示）
- ✅ 4つの学び方（スライド、体験、クイズ、チャレンジ）
- ✅ AI実行機能（キャッシュ・制限機能付き）
- ✅ クイズ採点・チャレンジ提出機能
