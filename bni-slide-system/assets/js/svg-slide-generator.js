...
async function generateSVGSlides(data, stats) {
  ...
  // ============================================
  // Slide 3-8: Use existing HTML/CSS slides for now
  // (Will be converted to SVG templates later)
  // ============================================
  ...
  if (thankYouSVG) {
    slides += `
      <section data-background-color="#CF2030">
        <div style="width: 100vw; height: 100vh; display: flex; align-items: center; justify-content: center;">
          ${thankYouSVG.replace('BNI週次レポート', 'ありがとうございました').replace('Givers Gain® | BNI Slide System', '来週もよろしくお願いします')}
        </div>
      </section>
    `;
  }
